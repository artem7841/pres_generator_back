...
public interface IService
{
    ...
    public Task<NewPresentation> GetPresenation(string prompt, string text, int userId, string model);

    public Task<byte[]> GetPresenationPptx(int id, IFileRepo fileRepo);
    public Task<NewPresentation> CorrectPresenation(int presId, string newPrompt, int userId);
}