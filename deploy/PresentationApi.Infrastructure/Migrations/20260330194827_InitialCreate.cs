        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasActiveSubscription = table.Column<bool>(type: "INTEGER", nullable: false),
                    SubscriptionExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    YookassaPaymentMethodId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
